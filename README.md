...
1. 下载最新版本：[web-font-switcher-v1.0.2.zip](https://github.com/CUinspace233/web-font-switcher/releases/download/v1.0.2/web-font-switcher-v1.0.2.zip)
2. 解压这个 zip 文件
...
1. Download the latest version: [web-font-switcher-v1.0.2.zip](https://github.com/CUinspace233/web-font-switcher/releases/download/v1.0.2/web-font-switcher-v1.0.2.zip)
2. Unzip the file
